...
<body>
                                    ...
                                    <div class="col-lg-12">
                                        <?php
                                            ...
                                            if(isset($_POST['submit'])) {
                                                ...
                                                $sql = "UPDATE drug_manufacturer SET name = '$name', phone_no = '$phone_no' WHERE drug_manufacturer_id = $drug_manufacturer_id";
                                        ...
                                        <form role="form" method="post" action="<?=$_SERVER['PHP_SELF']?>">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>Select Drug Manufacturer ID</label>
                                                    <select class="form-control" name="drug_manufacturer_id" required="">
                                                        <?php
                                                            ...
                                                            $cdquery="SELECT drug_manufacturer_id FROM drug_manufacturer";
                                                            $cdresult=mysql_query($cdquery) or die ("Query to get data from firsttable failed: ".mysql_error());

                                                            while ($cdrow=mysql_fetch_array($cdresult)) {
                                                            $cdTitle=$cdrow["drug_manufacturer_id"];
                                                                echo "<option>
                                                                    $cdTitle
                                                                </option>";
                                                            }
    ...
    <script>
        $(document).ready(function() {
            $('#example').DataTable( {
                ...
                "processing": true,
                "serverSide": true,
                "sAjaxSource": "../scripts/db_drug_manufacturer.php"
            } );
        } );
    </script>
    ...
    $(document).ready(function() {
        ...
        $('#deleteButton').click( function () {
            ...
            var drug_manufacturer_id = (data[0][1]);

            console.log(drug_manufacturer_id);
            $.ajax({
                data: 'data=' + drug_manufacturer_id,
                url: '../scripts/del_drug_manufacturer.php',
                method: 'POST',
