                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <?php
                                            ...
                                            if(isset($_POST['submit'])) {
                                                ...
                                                $sql = "INSERT INTO doctor (first_name, last_name, department) VALUES ('$first_name', '$last_name', '$department')";
                                        ...
                                        <form role="form" method="post" action="<?=$_SERVER['PHP_SELF']?>">
                                            <div class="form-group">
                                                ...
                                                <div class="tooltip-demo">
                                                    <p class="help-block" style="cursor: default;"><a data-toggle="tooltip" data-placement="top" title="" data-original-title="table name" style="color:#737373;">doctor</a> → <a data-toggle="tooltip" data-placement="top" title="" data-original-title="column name" style="color:#737373;">first_name</a></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="tooltip-demo">
                                                    <p class="help-block" style="cursor: default;"><a data-toggle="tooltip" data-placement="top" title="" data-original-title="table name" style="color:#737373;">doctor</a> → <a data-toggle="tooltip" data-placement="top" title="" data-original-title="column name" style="color:#737373;">last_name</a></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="tooltip-demo">
                                                    <p class="help-block" style="cursor: default;"><a data-toggle="tooltip" data-placement="top" title="" data-original-title="table name" style="color:#737373;">doctor</a> → <a data-toggle="tooltip" data-placement="top" title="" data-original-title="column name" style="color:#737373;">department</a></p>
                                                </div>
                                            </div>
